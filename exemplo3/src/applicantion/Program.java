...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		for (int i = 1; i <= n; i++) {
			...
			double contractValue = keyboard.nextDouble();
			System.out.print("Duration (hours): ");
			int contractDuration = keyboard.nextInt();

			HourContract contract = new HourContract(contractDate, contractValue, contractDuration);
